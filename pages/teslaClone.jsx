    ...
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
        <div className='col-span-4'>
          ...
          <button className='px-8 py-2 mt-4 mr-8'><a target="_blank" rel="noreferrer" href="https://tesla-clone-six-swart.vercel.app/" >Demo</a></button>
          <button className='px-8 py-2 mt-4'><a target="_blank" rel="noreferrer" href="https://github.com/pontos21/Tesla-Clone">Code</a></button>
        </div>
